...
void Game::hardDrop(){//硬降
    ...
    player->setSource(QUrl::fromLocalFile("./resources/music/down.wav"));
    player->setVolume(10);
    player->play();
}
...
void Game::removeFullLines(int from, int to) {
    ...
    QSoundEffect *player= new QSoundEffect;//消除音效
    player->setSource(QUrl::fromLocalFile("./resources/music/remove.wav"));
    player->setVolume(80);
    player->play();
}
